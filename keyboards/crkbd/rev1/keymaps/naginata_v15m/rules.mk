...
MOUSEKEY_ENABLE = no	# Mouse keys						# 1312 bytes (v0.23.4)
EXTRAKEY_ENABLE = no	# Audio control and System control	# 488 bytes (v0.23.4)
NKRO_ENABLE = no		# Enable N-Key Rollover				# 346 bytes (v0.23.4)
...
OLED_ENABLE		= yes										# 3720 bytes (v0.23.4)
OLED_DRIVER		= ssd1306
