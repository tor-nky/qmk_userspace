...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT(
        ...
        _______,    JP_TILD, JP_DLR,JP_HASH,JP_LCBR,JP_RCBR,   KC_0,   KC_1,   KC_2,   KC_3, KC_DOT,JP_PERC,             _______,          _______,          _______,_______,_______,_______,
    ...
    [_RAISE] = LAYOUT(
        _______, _______,_______,_______,_______,  _______,_______,_______,_______,  _______,_______,_______,_______,  _______,_______,_______,
        _______, _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,  _______,_______,_______,  _______,_______,_______,_______,
         KC_PWR,    KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,MS_LEFT,MS_DOWN,  MS_UP,MS_RGHT,MS_BTN1,MS_BTN2,_______,       _______,  _______,_______,_______,  _______,_______,_______,_______,
        _______,     KC_F6,  KC_F7,  KC_F8,  KC_F9, KC_F10,KC_LEFT,KC_DOWN,  KC_UP,KC_RGHT,MS_BTN3, WSHOOT,_______,                                          _______,_______,_______,
        _______,     KC_F11, KC_F12,KC_PSCR,KC_SCRL,KC_PAUS,KC_HOME,KC_PGDN,KC_PGUP, KC_END,MS_WHLD,MS_WHLU,             _______,          _______,          _______,_______,_______,_______,
